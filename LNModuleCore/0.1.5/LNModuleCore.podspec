#
# Be sure to run `pod lib lint LNModuleCore.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/NoNameOrganazation/LNModuleCore.git', :tag => s.version.to_s }
